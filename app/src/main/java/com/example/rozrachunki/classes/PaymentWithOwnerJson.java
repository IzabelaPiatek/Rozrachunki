...
public class PaymentWithOwnerJson {
    ...
    public PaymentWithOwnerJson(Integer id, Integer idGroup, Integer paidBy, Integer amount, String description, String date, byte[] image, String note, boolean settled, Integer payment_option, String ownerUsername) {
        this.id = id;
